...
Turn the following debug flag in the JVM on:
...
```openssl s_client -connect <host>:<443>```  and check the "Certificate chain" part.
...
https://softwareengineering.stackexchange.com/questions/308532/how-is-this-java-keystore-cert-still-valid
